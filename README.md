# "Mystorage", location-based warehousing (in development)
...
in format "A-01-01", where 'A' is section, middle '01' is level, and last '01' is a<br>
right offset of cell on that level. Fex. 5th level of section B with offset 15 means<br>
"B-05-15". The rest of the necessary tables will be created for you.<br>
