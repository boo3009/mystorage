...
//-------------------------balanceModelView connects
	...
	connect(search_by_cell_PB,&QPushButton::clicked,this,[this](){slot_show_search_dialog(0);});
	connect(search_by_item_PB,&QPushButton::clicked,this,[this](){slot_show_search_dialog(1);});
}
