...
distdir: FORCE
	...
	$(COPY_FILE) --parents db.h itemDialog.h incomeDialog.h outcomeDialog.h proxy_models.h search_dialog.h search_item_dialog.h mainWindow.h $(DISTDIR)/
...
compiler_moc_header_make_all: moc_db.cpp moc_itemDialog.cpp moc_incomeDialog.cpp moc_outcomeDialog.cpp moc_proxy_models.cpp moc_search_dialog.cpp moc_search_item_dialog.cpp moc_mainWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_db.cpp moc_itemDialog.cpp moc_incomeDialog.cpp moc_outcomeDialog.cpp moc_proxy_models.cpp moc_search_dialog.cpp moc_search_item_dialog.cpp moc_mainWindow.cpp
moc_db.cpp: db.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
